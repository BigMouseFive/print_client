...
<div class="main">
  ...
  <div class="panel active" id="panel-fnsku">
    ...
    <div class="card">
      ...
      <div class="pdf-preview" id="fnsku-pdf-preview" style="display:none">
        <iframe id="fnsku-pdf-iframe" style="width:100%;height:200px;border:0.5px solid var(--border);border-radius:var(--rsm)"></iframe>
      </div>
      ...
      <div style="display:flex;gap:8px">
        <button class="btn btn-ghost btn-full" onclick="previewFnsku(event)" id="btn-fnsku-preview">预览效果</button>
  ...
  <div class="panel" id="panel-box">
    ...
    <div class="card">
      ...
      <div class="pdf-preview" id="box-pdf-preview" style="display:none">
        <iframe id="box-pdf-iframe" style="width:100%;height:200px;border:0.5px solid var(--border);border-radius:var(--rsm)"></iframe>
      </div>
      <div class="copies-bar">
        <label>打印份数</label>
      ...
      <div style="display:flex;gap:8px">
        <button class="btn btn-ghost btn-full" onclick="previewBox(event)" id="btn-box-preview" disabled>预览效果</button>
        <button class="btn btn-blue btn-full" id="btn-box" onclick="doBox(event)" disabled>打印外箱标签</button>
      </div>
    </div>
  </div>
